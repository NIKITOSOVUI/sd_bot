...
RESTAURANT_CLOSE = datetime.time(9, 0)
...
ORDER_END_TIME = datetime.time(9, 00)  # ← НОВОЕ: заказы принимаются до 20:30
PICKUP_ORDER_END_TIME = datetime.time(9, 00)  # ← НОВОЕ: для самовывоза заказы (и "Ближайшее время") до 20:45
