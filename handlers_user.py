...
RESTAURANT_CLOSE = datetime.time(21, 00)
...
ORDER_END_TIME = datetime.time(19, 30)  # ← НОВОЕ: заказы принимаются до 20:30
PICKUP_ORDER_END_TIME = datetime.time(19, 30)  # ← НОВОЕ: для самовывоза заказы (и "Ближайшее время") до 20:45
